...
@Preview
@Composable
fun ListMobilePortraitLightPreview() {
    SamplePreview {
        Surface {
            ListMobileSampleContent(contacts = SampleData.contacts)
        }
    }
}
...
@Preview
@Composable
fun ListMobilePortraitDarkPreview() {
...
@Preview
@Composable
fun ListMobileLandscapeLightPreview() {
...
@Preview
@Composable
fun ListMobileLandscapeDarkPreview() {
