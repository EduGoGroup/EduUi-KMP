...
@Preview
@Composable
fun LoginSampleErrorPreview() {
    SamplePreview {
        Surface {
            var email by remember { mutableStateOf("usuario@test.com") }
            ...
            LoginSampleContent(
                ...
                rememberMe = rememberMe,
                onRememberMeChange = { rememberMe = it },
                errorMessage = "Credenciales invalidas. Verifica tu correo y contrasena.",
            )
        }
    }
}
...
@Preview
@Composable
fun LoginSampleLoadingPreview() {
    SamplePreview {
        Surface {
            LoginSampleContent(
                email = SampleData.emailPlaceholder,
                onEmailChange = {},
